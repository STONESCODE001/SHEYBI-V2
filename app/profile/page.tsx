    ...
    <AuthenticatedLayout>
      <div className="mx-auto flex max-w-4xl flex-col gap-8 md:gap-10">
        ...
        <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
          ...
          <StatisticCard label="Profit" value="+$450" />
        </div>

        <div className="flex flex-col gap-4">
          <SectionHeader title="Recent Activity" />
          <div className="flex h-32 items-center justify-center rounded-xl border border-dashed border-[var(--border)] bg-[var(--surface-subtle)] text-sm text-[var(--text-muted)]">
