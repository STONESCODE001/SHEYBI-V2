        ...
        <div className="flex flex-col gap-4 w-full">
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full flex flex-col gap-4">
            ...
            <TabsContent value="open" className="mt-4 flex flex-col gap-4">
              {positionsLoading ? (
                <div className="p-8 text-center text-sm text-[var(--text-muted)]">Loading positions...</div>
            ...
            <TabsContent value="closed" className="mt-4 flex flex-col gap-3">
              {positionsLoading ? (
                <div className="p-8 text-center text-sm text-[var(--text-muted)]">Loading closed positions...</div>
            ...
            <TabsContent value="history" className="mt-4 flex flex-col gap-3">
              {ledgerLoading ? (
                <div className="p-8 text-center text-sm text-[var(--text-muted)]">Loading trade history...</div>
